...
type PositionActivityWhereInput struct {
	...
	PositionNot           *PositionWhereInput     `json:"position_not,omitempty"`
	PositionIn            []*PositionWhereInput   `json:"position_in,omitempty"`
	PositionNotIn         []*PositionWhereInput   `json:"position_not_in,omitempty"`
...
type PositionWhereInput struct {
	...
	PoolNot                    *PoolWhereInput   `json:"pool_not,omitempty"`
	PoolIn                     []*PoolWhereInput `json:"pool_in,omitempty"`
	PoolNotIn                  []*PoolWhereInput `json:"pool_not_in,omitempty"`
}
