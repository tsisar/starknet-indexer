...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			positionactivity.Table: positionactivity.ValidColumn,
			protocolstat.Table:     protocolstat.ValidColumn,
			stableswapstat.Table:   stableswapstat.ValidColumn,
			swapevent.Table:        swapevent.ValidColumn,
